...
enum ts_symbol_identifiers {
  ...
  sym_comment = 68,
  sym_semgrep_ellipsis = 69,
  sym_semgrep_metavariable = 70,
  sym_source_file = 71,
  sym_project_file = 72,
  sym_module_file = 73,
  sym_quoted_schema = 74,
  sym_contents = 75,
  sym_schema = 76,
  sym_quoted_version = 77,
  sym_model = 78,
  sym_module = 79,
  ...
  sym_relation_def = 83,
  sym_operator = 84,
  sym_direct_relationship = 85,
  sym_conditional = 86,
  sym_indirect_relation = 87,
  sym_relation_ref = 88,
  sym_all = 89,
  sym_condition_declaration = 90,
  sym_param = 91,
  sym_type_identifier = 92,
  sym_condition_body = 93,
  ...
  aux_sym_module_file_repeat1 = 101,
  aux_sym_contents_repeat1 = 102,
  aux_sym_relations_repeat1 = 103,
  aux_sym_relation_def_repeat1 = 104,
  aux_sym_direct_relationship_repeat1 = 105,
  aux_sym_condition_declaration_repeat1 = 106,
...
static const char * const ts_symbol_names[] = {
  ...
  [anon_sym_with] = "with",
  [anon_sym_from] = "from",
  [anon_sym_POUND] = "imm_tok_prec_p1_hash",
  [anon_sym_COLON_STAR] = "imm_tok_colonstar",
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [139] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_module_file_repeat1, 2, 0, 0), SHIFT_REPEAT(111),
  ...
  [229] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_contents_repeat1, 2, 0, 0), SHIFT_REPEAT(115),
  ...
  [244] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_all, 2, 0, 0),
  ...
  [253] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_relation_ref, 3, 0, 0),
